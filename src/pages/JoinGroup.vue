    ...
    <q-page class="flex flex-center join-group-page" :class="joinFlag ? 'loading' : ''">
        ...
        <div class="container">
            ...
            <div class="key-pad" v-show="!joinFlag">
                <div class="key-pad__number number-1" @click="() => { clickKeyPad('1') }"><img src="~assets/1.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-2" @click="() => { clickKeyPad('2') }"><img src="~assets/2.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-3" @click="() => { clickKeyPad('3') }"><img src="~assets/3.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-4" @click="() => { clickKeyPad('4') }"><img src="~assets/4.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-5" @click="() => { clickKeyPad('5') }"><img src="~assets/5.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-6" @click="() => { clickKeyPad('6') }"><img src="~assets/6.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-7" @click="() => { clickKeyPad('7') }"><img src="~assets/7.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-8" @click="() => { clickKeyPad('8') }"><img src="~assets/8.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-9" @click="() => { clickKeyPad('9') }"><img src="~assets/9.png"
                        alt="" srcset="">
                </div>
                <div class="key-pad__number number-block"></div>
                <div class="key-pad__number number-0" @click="() => { clickKeyPad('0') }"><img src="~assets/0.png"
                        alt="" srcset=""></div>
                <div class="key-pad__number number-back" @click="() => { clickKeyPad('back') }"><img
                        src="~assets/back.png" alt="" srcset=""></div>
            </div>
        </div>
